    ...
    return (
        <div className="flex items-center justify-between bg-white px-4 py-4 dark:bg-black dark:px-4 dark:py-3">
            ...
            <div className='flex items-center'>
                <button onClick={() => dispatch(setIsDarkMode(!isDarkMode))} className={isDarkMode ? `rounded p-2 dark:hover:bg-gray-700` : `rounded p-2 hover:bg-gray`}>
                    {isDarkMode ? (
                ...
                className={isDarkMode 
                    ...
                    : `h-min w-min first-letter:rounded p-2 hover:bg-gray`}
                >
